...
import { User2, Mail, Lock, Eye, EyeOff, ArrowLeft } from "lucide-react";
...
export default function PortalLogin() {
  ...
  const loginMutation = useMutation({
    mutationFn: async (data: LoginFormData) => {
      const response = await apiRequest("POST", "/api/auth/portal/login", data);
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-background via-background to-accent/10">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription>
              Acesse seu portal para acompanhar suas apólices e documentos
            </CardDescription>
          </CardHeader>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <CardFooter className="flex flex-col gap-4">
                ...
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  <p className="mt-1">Solicite ao seu corretor de seguros</p>
                </div>
              </CardFooter>
            </form>
          </Form>
      ...
      <footer className="py-4 text-center text-sm text-muted-foreground">
        <p>SeguroPro - Portal do Cliente</p>
      </footer>
    </div>
  );
}
